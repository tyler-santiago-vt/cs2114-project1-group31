...
/**
 * The test class for QuestionBank, verifying each category has the expected
 * questions, the letter/name lookup methods behave correctly, and invalid
 * categories or indices are handled predictably.
 *
...
public class QuestionBankTest
{
    ...
    {
        assertSame(
            bank.getAnimalQuestions(),
            bank.getQuestionsForCategory("A"));
        assertSame(bank.getMusicQuestions(), bank.getQuestionsForCategory("B"));
        assertSame(
            bank.getGeographyQuestions(),
            bank.getQuestionsForCategory("C"));
        assertSame(
            bank.getPeopleQuestions(),
            bank.getQuestionsForCategory("D"));
        assertSame(
            bank.getHistoryQuestions(),
            bank.getQuestionsForCategory("E"));
    }
    ...
    /**
     * Bad-input case: an unrecognized letter returns null rather than throwing.
     */
    @Test
    ...
    /**
     * Normal case: getQuestion returns the correct question by letter and
     * index.
     */
    @Test
    ...
    /**
     * Normal case: getQuestion also accepts a category name instead of a
     * letter.
     */
    @Test
